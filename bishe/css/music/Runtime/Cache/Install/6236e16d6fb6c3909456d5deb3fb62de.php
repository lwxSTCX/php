...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/music/Public/static/bootstrap-3.1.1/css/bootstrap.min.css" rel="stylesheet">
		<link href="/music/Public/static/JYmusic/css/jy.css" rel="stylesheet">
        <link href="/music/Public/Install/css/install.css" rel="stylesheet">
        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js"></script>
        <![endif]-->
        <script src="/music/Public/static/jquery-1.10.2.min.js"></script>
		<script type="text/javascript">
		(function(){
			window.JY = {
				"ROOT"   : "/music", //当前网站地址
				"APP"    : "/music/install.php?s=", //当前项目地址
				"PUBLIC" : "/music/Public", //项目公共目录地址
        ...
        <script src="/music/Public/static/JYmusic/js/jy.js"></script>
    </head>

    <body>
    	<div class="container">
    		<div class="page-header">
        		<h3><a href="http://jyuu.cn/"><img src="/music/Public/static/logo.png"></a><span>在线安装</span></h3>
      		</div>
...
<h4>安装进度</h4>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <form action="/music/install.php?s=/install/step2.html"  method="post" id="iform" target="_self" class="form-horizontal">
