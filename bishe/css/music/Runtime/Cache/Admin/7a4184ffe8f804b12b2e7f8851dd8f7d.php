...
<head>
   ...
   <link type="image/x-ico; charset=binary" rel="shortcut icon" href="/music/Public/Admin/images/favicon.ico">  
   <!--[if lt IE 9]>
   ...
   <link rel="stylesheet" href="/music/Public/Admin/css/csspinner.min.css">
   
   <link rel="stylesheet" href="/music/Public/Admin/css/app.css?1.1">
   <script type="application/javascript" src="/music/Public/Admin/js/modernizr.js"></script>
   <script type="application/javascript" src="/music/Public/Admin/js/fastclick.js" ></script>
   <script type="text/javascript" src="/music/Public/static/jquery-1.10.2.min.js"></script>
   <script type="text/javascript" src="/music/Public/static/bootstrap-3.1.1/js/bootstrap.min.js"></script>
</head>
	           ...
	           <li>
	              <div data-toggle="collapse-next" class="item user-block has-submenu">
	                 <div class="user-block-picture">
	                    <img src="/music/Public/Admin/images/avatar.png" alt="Avatar" width="60" height="60" class="img-thumbnail img-circle">
...
<div class="row">
    ...
    <script type="text/javascript" src="/music/Public/Admin/js/JYmusic.js"></script>
   	<script type="text/javascript" src="/music/Public/static/jquery.slimscroll.min.js"></script>
   	<script type="text/javascript" src="/music/Public/Admin/js/app.js?v=0.1"></script>
   	
<link href="/music/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/music/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/music/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/music/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/music/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
