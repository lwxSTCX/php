...
<head>	
	...
	<script type="text/javascript">(function(){window.JY = {"ROOT"   : "/music","APP": "/music/index.php?s=","PUBLIC" : "/music/Public","DEEP"   : "<?php echo C('URL_PATHINFO_DEPR');?>","MODEL": ["<?php echo C('URL_MODEL');?>", "<?php echo C('URL_CASE_INSENSITIVE');?>", "<?php echo C('URL_HTML_SUFFIX');?>"],"VAR": ["<?php echo C('VAR_MODULE');?>", "<?php echo C('VAR_CONTROLLER');?>","<?php echo C('VAR_ACTION');?>"]}})();
	</script>
	...
	<div class="container">
		<div class="row clearfix">
			...
			<section class="col-sm-6 col-sm-offset-3 login-box">
				<?php if(ACTION_NAME == 'findpwd'): ?><h2 class="mb_20"><i class="jy jy-login mr_20"></i>找回密码</h2><br>
				<form class="form-horizontal" action="<?php echo U();?>">
