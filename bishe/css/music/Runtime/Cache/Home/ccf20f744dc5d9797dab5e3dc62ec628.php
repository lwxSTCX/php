<?php if (!defined('THINK_PATH')) exit();?> <?php if(!empty($list)): ?><link rel="stylesheet" type="text/css" media="all" href="/music/Addons/Slider/slider.css">
<style type="text/css">
			...
			<?php if(($addons_config["show_model"]) != "3"): ?><div class="col-md-4 hidden-xs hidden-sm">				
				<div class="sl_s_list" style="height:<?php echo ($addons_config["height"]); ?>;">
					...
					<div class="text-center loading">
						<img src="/music/Addons/Slider/images/loader.gif"  alt="正在努力加载....">
					</div>
...
<hr>
<script src="/music/Addons/Slider/jquery.flexslider-min.js"></script>
<script type="text/javascript">
// flexslider 幻灯片
(function(){
