...
?>
  <tr>
    ...
    <td height="25" align="center" valign="middle" class="left">&nbsp;
    <?php 
	$query8=mysql_query("select possible,knxdj from xiangcheng where cuiruoxingdj='".$myrow4['cuiruoxingdj']."' and weixiedj='".$myrow7['weixiedj']."'") or die(mysql_error());
    ...
    <td height="25" align="center" valign="middle" class="left">&nbsp;
    <?php 
	$query9=mysql_query("select sunshizhi,sunshidj from xiangcheng where zichanjz='".$myrow2['zichanjz']."' and cuiruoxingdj='".$myrow4['cuiruoxingdj']."'") or die(mysql_error());
    ...
    <td height="25" align="center" valign="middle" class="left">&nbsp;<?php echo $myrow9['sunshidj'];?></td>
     <td height="25" align="center" valign="middle" class="left">&nbsp;
    <?php 
	$query10=mysql_query("select fengxianzhi,fengxiandj from xiangcheng where knxdj='".$myrow8['knxdj']."' and sunshidj='".$myrow9['sunshidj']."'") or die(mysql_error());
