...
<table width="720"  border="1" cellpadding="0" cellspacing="0">
  ...
  <?php
  		$pjid=$_POST['pjid'];
    	$chaxun="select * from juzheng where pjid='".$pjid."'";
    	$re=mysql_query($chaxun);
    	if(mysql_num_rows($re)>0){
    		$shanchu="delete from juzheng where pjid='".$pjid."'";
...
?>
  <tr>
    ...
    <?php
		...
		$insert="insert into juzheng(pjid,zichanname,zichanjz,cuiruoxingname,cuiruoxingdj,weixiename,weixiedj,
