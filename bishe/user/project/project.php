...
回来
<body>
<form action="projectdy.php" method="post">
<input name="manager" type="hidden" value="<?php echo $_SESSION['name'];?>">
...
?>
  <tr>
    ...
    <td height="25" align="center" valign="middle" class="center">&nbsp;<?php echo $array['content']?></td> 
       <td>
<form action="pdstate.php" method="post">
<input name="pjid" type="hidden" value="<?php echo $array['pjid']?>">
<input name="start" type="submit" value="项目向导"> 
</form>
</td>
 <td>
