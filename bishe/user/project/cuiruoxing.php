...
<form id="addcuiruoxing" name="addcuiruoxing" enctype="multipart/form-data" method="post" action="addcuiruoxing.php" >
    <tr>
        <td colspan="2" height="25" align="center" valign="middle" class="first">添加脆弱性</td>
        <tr>
        <td width="122" height="25" align="right" class="left">脆弱性名称：</td>
        <td width="595" class="right">&nbsp;
          <input id="cuiruoxingname" type="text" name="cuiruoxingname" size="25" class="txt">
      <font color="#FF0000">*</font>		</td>
    </tr>
    <tr>
        <td height="25" align="right" class="left">脆弱性等级：</td>
	...
	<tr>
    	<td height="80" align="right" class="left">脆弱性描述：</td>
    	<td height="25" class="right">&nbsp;<textarea id="cuiruoxingms" name="cuiruoxingms" cols="70" rows="8">暂无介绍</textarea></td>
    </tr>
    </tr>
    <tr>
