...
<table  width="500" border="0" align="center" cellpadding="0" cellspacing="0">
 <form id="register" name="register" action="login1.php" method="post" >
 	<tr>
    	<td colspan="5" align="center" valign="middle"><h2>后台登录页面</h2></td>
    </tr>
    <tr>
      <td width="95" height="25"><div align="right">用户名：</div></td>
      <td height="25" colspan="3">&nbsp;
          <input id="username" name="username" type="text"  /><input id="c_name" name="c_anme" type="hidden" value="not" >&nbsp;<font color="red">*</font></td>
      <td height="25"><div id="name1"><font color="#999999">请输入用户名</font></div></td>
    </tr>
    <tr>
      <td height="25"><div align="right">密&nbsp;&nbsp;&nbsp;&nbsp;码：</div></td>
      <td height="25" colspan="3">&nbsp;
          <input id="password" name="password" type="password"  />&nbsp;<font color="red">*</font></td>
