...
<form id="addcommo" name="addcomm" enctype="multipart/form-data" method="post" action="addcommo1.php" >
   ...
   <tr>
    ...
    <tr>
    	...
    	<td height="25" class="right">&nbsp;<input id="m_price" name="m_price" type="text" class="shorttxt" >&nbsp;元
            <font color="#FF0000">*</font>        </td>
    </tr>
	<tr>
        <td height="25" align="right" class="left">打折率：</td>
        <td height="25" class="right">&nbsp;<input id="fold" name="fold" type="text" value="9" class="shorttxt" >&nbsp;折
            <font color="#FF0000">*</font>        </td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td height="25" class="right"><div id="dt"><?php echo "当前时间是 : 20" . date("y-m-d H:i:sa"); ?></div></td>
    </tr>
	<tr>
