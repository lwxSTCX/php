...
insert into `cuiruoxing`(`pjid`,`cuiruoxingid`,`cuiruoxingname`,`cuiruoxingdj`,`zichangl`,`cuiruoxingms`) values('20','40','爆破弱口令','4','0','爆破弱口令');
insert into `cuiruoxing`(`pjid`,`cuiruoxingid`,`cuiruoxingname`,`cuiruoxingdj`,`zichangl`,`cuiruoxingms`) values('20','41','拒绝服务攻击','5','0','拒绝服务攻击');
...
insert into `cuizigl`(`cuiruoxingid`,`zichanid`,`pjid`) values('27','24','13');
insert into `cuizigl`(`cuiruoxingid`,`zichanid`,`pjid`) values('41','32','20');
insert into `cuizigl`(`cuiruoxingid`,`zichanid`,`pjid`) values('40','33','20');
insert into `cuizigl`(`cuiruoxingid`,`zichanid`,`pjid`) values('40','32','20');
...
insert into `juzheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('9','3','5','2','3','2','5','17','4','16','4','20','4');
insert into `juzheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('20','外网','4','拒绝服务攻击','5','攻击','4','22','5','22','5','25','5');
insert into `juzheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('20','外网','4','爆破弱口令','4','弱口令','3','16','3','19','4','16','3');
insert into `juzheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('20','内网','5','爆破弱口令','4','弱口令','3','16','3','21','5','20','4');
...
insert into `links`(`id`,`title`,`url`) values('1','哈尔滨工业大学(威海)','http://www.hitwh.edu.cn');
...
CREATE TABLE `projectinfo` (
  ...
  PRIMARY KEY (`pjid`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=gbk COLLATE=gbk_bin;
insert into `projectinfo`(`pjid`,`project`,`companyname`,`manager`,`phone`,`type`,`questionnaire`,`date`,`content`,`url`,`state`) values('5','威海电厂风险评估项目','威海电厂','张三','2147483647','Energy','1','2018-03-15','威海电厂风险评估项目是一项大项目','','');
...
insert into `projectinfo`(`pjid`,`project`,`companyname`,`manager`,`phone`,`type`,`questionnaire`,`date`,`content`,`url`,`state`) values('21','哈工大','哈工大','张三三','17862702537','学校','','2018-06-01','哈工大','','1');
insert into `projectinfo`(`pjid`,`project`,`companyname`,`manager`,`phone`,`type`,`questionnaire`,`date`,`content`,`url`,`state`) values('22','北京大学','北京大学','张三三','17862702537','学校','','2018-06-01','暂无介绍','','1');
insert into `projectinfo`(`pjid`,`project`,`companyname`,`manager`,`phone`,`type`,`questionnaire`,`date`,`content`,`url`,`state`) values('20','哈尔滨工业大学风险评估','哈尔滨工业大学','张三三','13333333333','学校','','2018-05-31','哈尔滨工业大学','','1');
...
insert into `weicuigl`(`weixieid`,`cuiruoxingid`,`pjid`) values('34','40','20');
insert into `weicuigl`(`weixieid`,`cuiruoxingid`,`pjid`) values('33','41','20');
...
insert into `weixie`(`weixieid`,`pjid`,`weixiename`,`weixiedj`,`weixiems`,`cuiruoxingid`) values('33','20','攻击','4','攻击','0');
insert into `weixie`(`weixieid`,`pjid`,`weixiename`,`weixiedj`,`weixiems`,`cuiruoxingid`) values('34','20','弱口令','3','弱口令','0');
...
insert into `xiangcheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('9','3','5','2','3','2','5','15','3','15','3','9','2');
insert into `xiangcheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('20','外网','4','爆破弱口令','4','弱口令','3','12','3.46','16','4','13.84','3.72');
...
insert into `xiangcheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('20','内网','5','爆破弱口令','4','弱口令','3','12','3.46','20','4.47','15.46','3.93');
...
insert into `xiangcheng`(`pjid`,`zichanname`,`zichanjz`,`cuiruoxingname`,`cuiruoxingdj`,`weixiename`,`weixiedj`,`possible`,`knxdj`,`sunshizhi`,`sunshidj`,`fengxianzhi`,`fengxiandj`) values('20','外网','4','拒绝服务攻击','5','攻击','4','20','4.47','20','4.47','19.98','4.47');
...
insert into `zichan`(`zichanid`,`pjid`,`zichanname`,`zichanjmx`,`zichanwzx`,`zichankyx`,`zichanjz`,`zichanms`) values('32','20','外网','4','4','5','4','外网');
insert into `zichan`(`zichanid`,`pjid`,`zichanname`,`zichanjmx`,`zichanwzx`,`zichankyx`,`zichanjz`,`zichanms`) values('33','20','内网','4','4','4','5','内网');
