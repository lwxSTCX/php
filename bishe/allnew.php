...
include_once("config.inc.php");	
	$sql =mysql_query("select * from tb_commo where isnew = 1 order by isnew,id desc") or die(mysql_error());	
  ...
  <tr>
    <td height="132" align="left" valign="middle">
      <table width="636" height="134" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="145" rowspan="5" align="center" valign="middle"><img src="image/2.jpg" width="90" height="100" alt="{$newarr[new_id].name}" style="border: 1px solid #f0f0f0;" /></td>
            <td height="35">商品名称：<?php echo $array['name']?></td>
            <td width="156" height="35">商品类别：<?php echo $array['class']?></td>
          ...
          <tr>
            <td height="30">会员价格：<font color="#FF0000"><?php echo $array['v_price']?>&nbsp;元</font></td>
