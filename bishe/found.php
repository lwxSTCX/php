...
<form id="foundname" name="found" method="post" action="found1.php">
  <tr>
  ...
  <tr>
    ...
    <td width="187" align="left" valign="middle" class="right"><input id="name" name="name" type="text" class="txt"></td>
  </tr>
  <tr>
    <td height="25" colspan="2" align="center" valign="middle"><input id="next1" name="next1" type="submit" class="btn" value="下一步" /></td>
    </tr>
</form>
</table>
</div>
